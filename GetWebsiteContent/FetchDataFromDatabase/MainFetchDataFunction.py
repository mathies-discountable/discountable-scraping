...
def fetch_data_from_database():
    ...
    response = supabase.table('Locality').select("locality_id", "name", "email_from_osm", "website").is_("error_code", "null").is_("has_discounts", "null").is_("email_sent", "false").not_.is_("website", "null").execute()
